...
import org.launchcode.techjobsauth.models.dto.LoginDTO;
...
public class AuthenticationController {
    ...
    public String processRegistration(@ModelAttribute @Valid RegisterDTO registerDTO,
        ...
        // see if there is an existing user with the same username
        ...
        // compare the password and verify fields
        ...
        // everything validates, create a new user
    ...
    @PostMapping("/login")
    public String processLogin(@ModelAttribute @Valid LoginDTO loginDTO,
                                   Errors errors, HttpServletRequest request,
                                   Model model) {
